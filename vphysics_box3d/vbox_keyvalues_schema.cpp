...
const Box3DKVSchemaFunc_t FillBaseProp =
{
	...
	[]( KeyValues *pProp, void *pPtr, size_t size )
	{
		...
		if ( nSurfaceIndex == -1 )
		{
			Log_Warning( LOG_VBox3D, "You must specify the base material %s before it can be used. Defaulting to 'default' as a base.\n", pProp->GetString() );
...
const Box3DKVSchemaFunc_t FillStringProp =
{
	0, // Varies.
	[]( KeyValues *pProp, void *pPtr, size_t size )
	{
...
const Box3DKVSchemaFunc_t FillIntProp =
{
	sizeof( int ),
	[]( KeyValues *pProp, void *pPtr, size_t size )
	{
...
const Box3DKVSchemaFunc_t FillFloatProp =
{
	sizeof( float ),
	[]( KeyValues *pProp, void *pPtr, size_t size )
	{
...
const Box3DKVSchemaFunc_t FillUnsignedCharProp =
{
...
const Box3DKVSchemaFunc_t FillBoolProp =
{
	sizeof( bool ),
	[]( KeyValues *pProp, void *pPtr, size_t size )
	{
...
const Box3DKVSchemaFunc_t FillVectorProp =
{
	sizeof( Vector ),
	[]( KeyValues *pProp, void *pPtr, size_t size )
	{
...
const Box3DKVSchemaFunc_t FillVector4DProp =
{
	sizeof( Vector4D ),
	[]( KeyValues *pProp, void *pPtr, size_t size )
	{
...
const Box3DKVSchemaFunc_t FillQAngleProp =
{
	sizeof( QAngle ),
	[]( KeyValues *pProp, void *pPtr, size_t size )
	{
...
const Box3DKVSchemaFunc_t FillIntPairProp =
{
	sizeof( Box3DPhysicsIntPair ),
	[]( KeyValues *pProp, void *pPtr, size_t size )
	{
...
const Box3DKVSchemaFunc_t FillGameMaterialProp =
{
...
const Box3DKVSchemaFunc_t FillSoundProp =
{
	sizeof( unsigned short ),
	[]( KeyValues *pProp, void *pPtr, size_t size )
	{
...
const Box3DKVSchemaFunc_t FillSurfaceProp =
{
	sizeof( int ),
	[]( KeyValues *pProp, void *pPtr, size_t size )
	{
...
void ParseBox3DKVSchema( KeyValues *pKV, const Box3DKVSchemaProp_t *pDescs, uint count, void *pObj, void *pUnknownKeyObj, IVPhysicsKeyHandler *pUnknownKeyHandler )
{
	bool bHandled = false;
    ...
    for ( KeyValues* pProp = pKV->GetFirstSubKey(); pProp != nullptr; pProp = pProp->GetNextKey() )
    {
        ...
        for ( uint i = 0; i < count; i++ )
        {
            ...
            {
                VBoxAssertMsg( desc.func.ptr_size == 0 || desc.size == desc.func.ptr_size, "Desc element size does not match function size");
