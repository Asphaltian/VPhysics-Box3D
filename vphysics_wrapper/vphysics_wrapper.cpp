...
//
// This is a thin CPU-agnostic wrapper for the actual Vox3D DLLs which are named
// vphysics_box3d_sse2.dll, vphysics_box3d_sse42.dll and vphysics_box3d_avx2.dll
//
//=================================================================================================
...
public:
	...
	// The CS:GO-era IAppSystem (used by GMod x64) has these extra methods; the public SDK's
	// IAppSystem does not.
#if defined( GAME_GMOD ) && PLATFORM_64BITS
...
static const char *GetModuleFromCPULevel( CPULevel_t level )
{
	switch ( level )
	{
		case CPU_HAS_AVX2:		return "vphysics_box3d_avx2" DLL_EXT_STRING;
		case CPU_HAS_SSE42:		return "vphysics_box3d_sse42" DLL_EXT_STRING;
		default:				return "vphysics_box3d_sse2" DLL_EXT_STRING;
	}
}
